...
SECRET_KEY = 'django-insecure-whc$9yshf^3r+z(5s$01$k#2-^p$7hlou#)&=b#nr$f)4dn6q)'
...
INSTALLED_APPS = ['django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes',
                  ...
                  "core", "core.user", "core.auth", "core.post", "core.comment", "rest_framework", 'drf_yasg']
...
DATABASES = {'default': {'ENGINE': 'django.db.backends.postgresql_psycopg2', 'NAME': 'coredb', 'USER': 'datinguser',
                         'PASSWORD': 'datinguser971', 'HOST': 'localhost', 'PORT': '5432', }}
